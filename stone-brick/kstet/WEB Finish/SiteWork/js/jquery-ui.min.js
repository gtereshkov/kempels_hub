...
jQuery.effects || (function (g) {
    ...
    function f() {
        var n = document.defaultView ? document.defaultView.getComputedStyle(this, null) : this.currentStyle, o = {}, l,
            m;
    ...
    g.extend(g.easing, {
        def: "easeOutQuad", swing: function (l, m, k, o, n) {
...
(function (a) {
    a.effects.highlight = function (b) {
        return this.queue(function () {
            var d = a(this), c = ["backgroundImage", "backgroundColor", "opacity"],
                f = a.effects.setMode(d, b.options.mode || "show"), e = {backgroundColor: d.css("backgroundColor")};
            if (f == "hide") {
                e.opacity = 0
            }
            a.effects.save(d, c);
...
(function (a) {
    a.effects.puff = function (b) {
        return this.queue(function () {
            var f = a(this), g = a.effects.setMode(f, b.options.mode || "hide"),
                e = parseInt(b.options.percent, 10) || 150, d = e / 100, c = {height: f.height(), width: f.width()};
            a.extend(b.options, {
                fade: true,
                mode: g,
    ...
    a.extend(a.ui.accordion, {
        version: "1.8", animations: {
            slide: function (j, h) {
                ...
                var c = j.toShow.css("overflow"), g = 0, d = {}, f = {}, e = ["height", "paddingTop", "paddingBottom"],
                    b;
                var i = j.toShow;
                b = i[0].style.width;
...
(function (a) {
    a.widget("ui.menu", {
        _create: function () {
            ...
            this.deactivate();
            if (this.hasScroll()) {
                var e = d.offset().top - this.element.offset().top, b = this.element.attr("scrollTop"),
...
(function (f) {
    ...
    f.widget("ui.button", {
        ...
        _create: function () {
            ...
            var g = this, i = this.options, j = this.type === "checkbox" || this.type === "radio",
                k = "ui-state-hover" + (!j ? " ui-state-active" : ""), h = "ui-state-focus";
            if (i.label === null) {
        ...
        _resetButton: function () {
            ...
            var j = this.buttonElement,
                ...
                h = this.options.icons, g = h.primary && h.secondary;
    ...
    b.widget("ui.dialog", {
        options: {
            ...
            var k = this, l = k.options, i = l.title || k.originalTitle || "&#160;",
                ...
                j = (k.uiDialog = b("<div></div>")).appendTo(document.body).hide().addClass(a + l.dialogClass).css({zIndex: l.zIndex}).attr("tabIndex", -1).css("outline", 0).keydown(function (m) {
            ...
            var d = this, g = d.options, c = d.uiDialog.css("position"),
...
(function (f) {
    ...
    f.ui.position = {
        fit: {
            ...
            left: function (i, j) {
                ...
                var l = f(window), k = i.left + j.elemWidth - l.width() - l.scrollLeft(),
                    h = j.my[0] === "left" ? -j.elemWidth : j.my[0] === "right" ? j.elemWidth : 0, m = -2 * j.offset[0];
                i.left += i.left < 0 ? h + j.targetWidth + m : k > 0 ? h - j.targetWidth + m : 0
            }, top: function (i, k) {
                if (k.at[1] === "center") {
                    return
                }
                var m = f(window), l = i.top + k.elemHeight - m.height() - m.scrollTop(),
                    h = k.my[1] === "top" ? -k.elemHeight : k.my[1] === "bottom" ? k.elemHeight : 0,
                    j = k.at[1] === "top" ? k.targetHeight : -k.targetHeight, n = -2 * k.offset[1];
    ...
    if (!f.offset.setOffset) {
        f.offset.setOffset = function (l, i) {
            ...
            var k = f(l), n = k.offset(), h = parseInt(f.curCSS(l, "top", true), 10) || 0,
...
(function (b) {
    ...
    b.widget("ui.slider", b.ui.mouse, {
        ...
        _normValueFromMouse: function (e) {
            ...
            var f = this._valueMax() - this._valueMin(), j = g * f, c = j % this.options.step,
        ...
        _refreshValue: function () {
            ...
            if (this.options.values && this.options.values.length) {
                ...
                var k = this.value(), h = this._valueMin(), l = this._valueMax(),
                    f = l != h ? (k - h) / (l - h) * 100 : 0;
                var c = {};
                ...
                (g == "max") && (this.orientation == "horizontal") && this.range[d ? "animate" : "css"]({width: (100 - f) + "%"}, {
                    queue: false,
                    duration: e.animate
                });
                (g == "min") && (this.orientation == "vertical") && this.range.stop(1, 1)[d ? "animate" : "css"]({height: f + "%"}, e.animate);
                (g == "max") && (this.orientation == "vertical") && this.range[d ? "animate" : "css"]({height: (100 - f) + "%"}, {
                    queue: false,
                    duration: e.animate
                })
            }
